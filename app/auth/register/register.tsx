...
const UserRegisterPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("User registration attempt with:", name, email, password);
  };

  return (
    <div className="min-h-screen bg-[url(/bg4.svg)] flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-lg bg-white">
