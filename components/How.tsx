...
const userSteps = [
  {
    ...
    icon: <FaUserPlus className="h-12 w-12 text-[#00d084]" />,
  },
  {
    title: "Find a Service",
    description: "Browse through our wide range of professional services.",
    icon: <FaSearch className="h-12 w-12 text-[#00d084]" />,
  },
  {
    title: "Book a Service",
    description: "Choose a convenient time and book your service with ease.",
    icon: <FaCalendarAlt className="h-12 w-12 text-[#00d084]" />,
  },
];
...
const providerSteps = [
  {
    ...
    icon: <FaClipboardList className="h-12 w-12 text-[#00d084]" />,
  },
  {
    title: "List Your Services",
    description: "Showcase your skills and set your availability.",
    icon: <FaBriefcase className="h-12 w-12 text-[#00d084]" />,
  },
  {
    title: "Grow Your Business",
    description: "Connect with clients and build your reputation.",
    icon: <FaStar className="h-12 w-12 text-[#00d084]" />,
  },
];
